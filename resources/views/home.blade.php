...
@section('content')
    ...
    @if($hero && $hero->is_active)
        <section class="hero d-flex align-items-center text-white position-relative" style="background-image: url('{{ $hero->bg_image ? asset('storage/' . $hero->bg_image) : asset('assets/images/placeholder.png') }}'); 
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($about->button_text && $about->button_url)
                            <a href="{{ $about->button_url }}" class="btn btn-outline-primary btnn">{{ $about->button_text }}</a>
                        @endif
                    </div>
                </div>
            </div>
                        ...
                        <div class="card shadow-sm h-100 border-0">
                            ...
                            <div class="img-fixed-wrapper">
                                <img src="{{ $project->cover_image ? asset('storage/' . $project->cover_image) : asset('assets/images/placeholder.png') }}"
                                     alt="{{ $project->title }}" class="img-fixed"
                                     onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholder.png') }}';">
                            </div>

                            <div class="card-body">
                                <div style="min-height:120px !important;width:100%;">
                                ...
                                <div style="min-height:40px;width:100%;">
                                    <a href="{{ route('singleportfolio', $project->slug) }}"
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm border-0">
                            ...
                            <div class="card-body">
                                ...
                                {{-- Button fixed height --}}
                                <div style="height:40px;width:100%;display:flex;align-items:end;justify-content:center;">
